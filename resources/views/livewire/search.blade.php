                    ...
                    <table class="formtable table--bordered" id="tbl_srch_flights">
                        <tr>
                            <td>From<span class="required">*</span>
                                <select wire:model="from" class="field--location" >
                            ...
                            <td>To<span class="required">*</span>
                                <select wire:model="to" class="field--location" >
                                    <option value="" disabled selected>Choose your departure city</option>
                                    <option value='DAM'>Damascus International Airport (DAM)</option>
                                    <option value='LTK'>Latakia Bassel Al-Assad International Airport (LTK)</option>
                                    <option value='ALP'>Aleppo International Airport (ALP)</option>
                        ...
                        <tr>
                            ...
                            <td>DEPART DATE<span class="required">*</span>
                                <input type="date" id="depart-date" wire:model="selDepartureDate" placeholder="dd/mm/yyyy">          
                            <td>
                                @if ($tripType === 'round-trip')
                                   <span id="return-date">Return DATE</span>
                                   <span id="return-date" class="required">*</span>
