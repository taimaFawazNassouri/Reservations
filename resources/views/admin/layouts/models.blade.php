...
<div id="videomodal" class="modal fade">
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-dark text-white border-0">
            <div class="modal-body p-7 mx-auto text-center">
                <h5>Valex Video call</h5>
                <img src="{{ URL::asset('Dashboard/img/faces/6.jpg') }}" class="rounded-circle user-img-circle w-8 h-8 mt-4 mb-3" alt="img">
                <h4 class="font-weight-semibold mb-1">Daneil Scott</h4>
                <h6>Calling...</h6>
                <div class="mt-5">
                    <div class="row">
                        <div class="col-4">
                        ...
                        <div class="col-4">
                            <a class="icon icon-shape rounded-circle mb-0 mr-3 text-white" href="#" data-dismiss="modal" aria-label="Close">
